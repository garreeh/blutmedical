...
$mail->Username = 'gajultos.garry123@gmail.com'; // Your Gmail email
$mail->Password = 'cndwlnpwswdtsopg'; // Your Gmail app-specific password or regular password

// Set the sender's email address (from the form)
$mail->setFrom($senderEmail, $fullName);
$mail->addAddress('gajultos.garry123@gmail.com'); // The GoDaddy email you're sending to
