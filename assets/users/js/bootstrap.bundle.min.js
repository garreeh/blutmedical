...
!(function (t, e) {
  ...
  const Ti = "modaltest",
    ...
    Li = "hidden.bs.modaltest",
    xi = "show.bs.modaltest",
    Di = "resize.bs.modaltest",
    Si = "click.dismiss.bs.modaltest",
    Ni = "keydown.dismiss.bs.modaltest",
    Ii = "mousedown.dismiss.bs.modaltest",
    Pi = "modaltest-open",
    ji = "show",
    Mi = "modaltest-static";
  class Hi extends B {
    constructor(t, e) {
      super(t),
        (this._config = this._getConfig(e)),
        (this._dialog = V.findOne(".modaltest-dialog", this._element)),
    ...
    show(t) {
      this._isShown ||
        ...
        j.on(this._dialog, Ii, () => {
          j.one(this._element, "mouseup.dismiss.bs.modaltest", (t) => {
    ...
    hide() {
      ...
      if (j.trigger(this._element, "hide.bs.modaltest").defaultPrevented)
        return;
      this._isShown = !1;
      ...
      t && (this._isTransitioning = !0),
        ...
        this._queueCallback(() => this._hidemodaltest(), this._element, t);
    }
    dispose() {
      [window, this._dialog].forEach((t) => j.off(t, ".bs.modaltest")),
    ...
    _showElement(t) {
      const e = this._isAnimated(),
        i = V.findOne(".modaltest-body", this._dialog);
      (this._element.parentNode &&
        this._element.parentNode.nodeType === Node.ELEMENT_NODE) ||
        document.body.append(this._element),
        (this._element.style.display = "block"),
        this._element.removeAttribute("aria-hidden"),
        this._element.setAttribute("aria-modaltest", !0),
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._focustrap.activate(),
              (this._isTransitioning = !1),
              j.trigger(this._element, "shown.bs.modaltest", {
                relatedTarget: t,
              });
          },
          this._dialog,
    ...
    _hidemodaltest() {
      (this._element.style.display = "none"),
        ...
        this._element.removeAttribute("aria-modaltest"),
    ...
    _triggerBackdropTransition() {
      if (
        j.trigger(this._element, "hidePrevented.bs.modaltest").defaultPrevented
      )
        return;
  ...
  j.on(
    document,
    "click.bs.modaltest.data-api",
    '[data-bs-toggle="modaltest"]',
    function (t) {
      const e = n(this);
      ...
      const i = V.findOne(".modaltest.show");
  ...
  class un extends B {
    ...
    dispose() {
      clearTimeout(this._timeout),
        j.off(this._element.closest(ln), cn, this._hidemodaltestHandler),
    ...
    _setListeners() {
      this._config.trigger.split(" ").forEach((t) => {
        ...
        (this._hidemodaltestHandler = () => {
          this._element && this.hide();
        }),
        j.on(this._element.closest(ln), cn, this._hidemodaltestHandler),
        this._config.selector
          ? (this._config = {
              ...this._config,
              trigger: "manual",
