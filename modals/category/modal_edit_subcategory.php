            ...
            <div class="modal-body">
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                  <button type="submit" class="btn btn-primary" id="saveSubCategoryButton">Save</button>
                  <!-- <input type="hidden" name="item_id" value="</?php echo $row['subcategory_id']; ?>"> -->
...
<script>
  ...
  $(document).ready(function() {
    $('#editCategoryModal form').submit(function(event) {
      ...
      var $saveButton = $('#saveSubCategoryButton');
