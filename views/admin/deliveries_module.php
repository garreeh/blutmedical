...
if ($result) {
  while ($row_shipped = mysqli_fetch_assoc($result)) {
    ?>
          ...
          <div id="content">
            ...
            <div class="container-fluid">
              ...
              <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Shipped Orders Module</h1>
              </div>
                ...
                <div class="col-xl-12 col-lg-12">
                  <div class="tab-pane fade show active" id="aa" role="tabpanel" aria-labelledby="aa-tab">
                    ...
                    <div class="table-responsive">
                      ...
                      <?php if ($row_shipped['view_shipped_order'] == 1): ?>
                        ...
                        <table class="table custom-table table-hover" name="delivery_table" id="delivery_table">
                          <thead>
                            <tr>
                              ...
                              <th>Total Payment</th>
                              <?php if ($row_shipped['complete_order'] == 1): ?>
                                <th>Manage</th>
                              <?php endif; ?>
    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        $('#delivery_table').on('click', 'tr td:nth-child(6) .fetchCustomerDetails', function () {
      ...
      $(document).ready(function () {
        ...
        $('#delivery_table').on('click', 'tr td:nth-child(9) .fetchDataFinish', function () {
          ...
          $.ajax({
            url: './../../modals/delivery/modal_add_complete.php', // Path to PHP script to fetch modal content
            method: 'POST',
            data: {
              cart_id: cart_id
            },
